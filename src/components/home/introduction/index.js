...
class home_introduction extends Component{
    render(){
        return(
          ...
          <div class="introduction row text-center m-auto">
            ...
            <hr />
              <div class="col-lg-6 col-md-12 p-5 ">
                <h2 class="pb-3">Recibir tratamiento en el Institut Guttmann</h2>
                <p class="">El Instituto de Salud Cerebral y Neurorrehabilitación representa una nueva manera de
              ...
              <div class="col-lg-6 col-md-12 m-auto ">
                <img src={immagenes(`./guttmann2.jpg`)} class=""/>
              </div>


              <div class="col-lg-6 col-md-12 p-5 ">
                <h2 class="pb-3 ">Referente internacional en Neurorrehabilitación</h2>
                <p class="">Con más de 55 años de experiencia, el Hospital de Neurorrehabilitación atiende a más de
                  4.500 personas cada año. </p>
                <p class="">Una entidad privada de iniciativa social dedicada a las personas y a ofrecerles la mejor neurorrehabilitación
                  especializada y el cuidado de la Salud Cerebral.</p>
                <p class=""><a href="https://www.guttmann.com/es/por-que-escoger-el-institut-guttmann"
                    title="¿Por qué escoger el Institut Guttmann?">¿Por qué escoger el Institut Guttmann?</a> </p>
                
                </div>
                <hr />
              <div class="col-lg-6 col-md-12 p-5 ">
                <h2 class="pb-3 ">Instituto de Salud Cerebral y Neurorrehabilitación</h2>
                <p class="">Un conjunto de clínicas en Guttmann Barcelona, especialmente pensadas y diseñadas para
                ...
                <p class=""><a href="https://www.guttmann.com/es/salud-cerebral"
                    title="Clínicas especializadas">Clínicas especializadas</a></p>
                <p class=""><a href="https://barcelona.guttmann.com/es/treatments" rel="noopener" target="_blank"
                    title="Tratamientos especializados">Tratamientos especializados</a></p>
              </div>

              <div class="col-lg-6 col-md-12 m-auto ">
                <img src={immagenes(`./guttmann.jpg`)} class=" "/>
              </div>
              <hr />
